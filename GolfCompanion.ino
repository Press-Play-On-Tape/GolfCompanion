...
void numberPlayers() {
  ...
  if (arduboy.justPressed(UP_BUTTON) && game.numberOfPlayers < 4)         { ++game.numberOfPlayers; }
  else if (arduboy.justPressed(DOWN_BUTTON)&& game.numberOfPlayers > 1)   { --game.numberOfPlayers; }
  else if (arduboy.justPressed(A_BUTTON))                                 { game.setState(GameState::PlayerNames_Init); }
  else if (arduboy.justPressed(B_BUTTON))                                 { game.setState(GameState::SplashScreen); }
...
void numberHoles() {
  ...
  else if (arduboy.justPressed(A_BUTTON))                               { game.setState(GameState::InGame_Init); }
  else if (arduboy.justPressed(B_BUTTON))                               { game.setState(GameState::PlayerNames_Init); }
...
void inGame() {
  ...
  arduboy.drawVerticalDottedLine(0, HEIGHT - (GRID_VERT_SPACING * (4 - game.numberOfPlayers)), GRID_HOLE_1_X, 2);
  arduboy.drawVerticalDottedLine(0, HEIGHT - (GRID_VERT_SPACING * (4 - game.numberOfPlayers)), GRID_HOLE_1_X + (1 * GRID_HORZ_SPACING), 2);
  arduboy.drawVerticalDottedLine(0, HEIGHT - (GRID_VERT_SPACING * (4 - game.numberOfPlayers)), GRID_HOLE_1_X + (2 * GRID_HORZ_SPACING), 2);  
  arduboy.drawVerticalDottedLine(0, HEIGHT - (GRID_VERT_SPACING * (4 - game.numberOfPlayers)), GRID_HOLE_1_X + (3 * GRID_HORZ_SPACING), 2);  
